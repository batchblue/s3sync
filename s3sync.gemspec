...
Gem::Specification.new do |s|
  s.name = %q{s3sync-jethar}
  s.version = "1.3.9"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["frahugo jethar"]
  s.date = %q{2011-11-12}
  s.email = %q{jethar.h@gmail.com}
  ...
  s.summary = %q{Fork of s3sync to be compatible with ruby 1.9 and adding etag display support.}
